...
open a ticket at https://bugs.php.net and reference the bug id using #NNNNNN.
    ...
    After removing magic quotes, the get_magic_quotes_gpc function caused a deprecate warning. get_magic_quotes_gpc can be used to detected the magic_quotes behavior and therefore should not raise a warning at any time. The patch removes this warning
...
To run tests the `make test` is used after a successful compilation of the sources.
